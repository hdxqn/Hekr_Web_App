...
function(e, t) {
    ...
    function b(e) {
        var t = K,
        n = Be[e];
        return n || (n = x(e, t), "none" !== n && n || (Me = (Me || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Me[0].contentDocument, t.write(), t.close(), n = x(e, t), Me.detach()), Be[e] = n),
        n
    }
    function w(e, t, n) {
        ...
        n && ("" !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), Ie.test(s) && We.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)),
        void 0 !== s ? s + "": s
    }
    function C(e, t) {
        return {
    ...
    function O(e, t, n) {
        ...
        if (Z.isEmptyObject(p))"inline" === ("none" === l ? b(e.nodeName) : l) && (d.display = l);
            ...
            for (r in p) s = L(h ? m[r] : 0, r, f),
            r in m || (m[r] = s.start, h && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    function q(e, t) {
        var n, r, i, o, s;
    ...
    function H(e, t, n) {
        ...
        u = function() {
            if (i) return ! 1;
            for (var t = Ge || A(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; u > s; s++) l.tweens[s].run(o);
    ...
    function B(e, t, n, r) {
        ...
        function(t, i) {
            n || kt.test(e) ? r(e, i) : B(e + "[" + ("object" == typeof i ? t: "") + "]", i, n, r)
        });
    ...
    var ie = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t: B) !== O && L(t), t = t || O, n = n || [], a = t.nodeType, "string" != typeof e || !e || 1 !== a && 9 !== a && 11 !== a) return n;
            if (!r && H) {
                if (11 !== a && (i = ye.exec(e))) if (s = i[1]) {
                    ...
                    n;
                    if ((s = i[3]) && w.getElementsByClassName) return Q.apply(n, t.getElementsByClassName(s)),
                    n
                }
                if (w.qsa && (!F || !F.test(e))) {
                    if (d = f = M, h = t, m = 1 !== a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
        ...
        function v(e, t, n, i, o, s) {
            ...
            r(function(r, s, a, u) {
                ...
                } else x = g(x === s ? x.splice(h, x.length) : x),
                o ? o(null, s, x, u) : Q.apply(s, x)
            })
        }
        function y(e) {
            for (var t, n, r, i = e.length,
            o = C.relative[e[0].type], s = o || C.relative[" "], a = o ? 1 : 0, u = d(function(e) {
                return e === t
            },
            s, !0), l = d(function(e) {
                return ee(t, e) > -1
            ...
            s, !0), c = [function(e, n, r) {
                ...
                return t = null,
                i
            }]; i > a; a++) if (n = C.relative[e[a].type]) c = [d(h(c), n)];
            else {
        ...
        function x(e, n) {
            ...
            s = function(r, s, a, u, l) {
                ...
                w = x.length;
                for (l && (D = s !== O && s); h !== w && null != (c = x[h]); h++) {
                    if (o && c) {
        ...
        var b, w, C, T, k, E, N, S, D, A, j, L, O, q, H, F, $, P, R, M = "sizzle" + 1 * new Date,
        B = e.document,
        W = 0,
        I = 0,
        _ = n(),
        ...
        L = t.setDocument = function(e) {
            ...
            return r !== O && 9 === r.nodeType && r.documentElement ? (O = r, q = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), H = !k(r), w.attributes = i(function(e) {
            ...
            $ = [], F = [], (w.qsa = ve.test(r.querySelectorAll)) && (i(function(e) {
                q.appendChild(e).innerHTML = "<a id='" + M + "'></a><select id='" + M + "-\f]' msallowcapture=''><option selected=''></option></select>",
                ...
                P.call(e, "[s!='']:x"),
                $.push("!=", se)
            }), F = F.length && new RegExp(F.join("|")), $ = $.length && new RegExp($.join("|")), t = ve.test(q.compareDocumentPosition), R = t || ve.test(q.contains) ?
            function(e, t) {
            ...
            function(e, t) {
                ...
                return n ? n: (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === B && R(B, e) ? -1 : t === r || t.ownerDocument === B && R(B, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
            }: function(e, t) {
                if (e === t) return j = !0,
                0;
                var n, i = 0,
        ...
        t.matchesSelector = function(e, n) {
            if ((e.ownerDocument || e) !== O && L(e), n = n.replace(fe, "='$1']"), !(!w.matchesSelector || !H || $ && $.test(n) || F && F.test(n))) try {
                var r = P.call(e, n);
                    ...
                    function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [s ? g.firstChild: g.lastChild], s && y) {
                                for (c = g[M] || (g[M] = {}), l = c[e] || [], d = l[0] === W && l[1], p = l[0] === W && l[2], f = d && g.childNodes[d]; f = ++d && f && f[m] || (p = d = 0) || h.pop();) if (1 === f.nodeType && ++p && f === t) {
                                    c[e] = [W, d, p];
                                    break
                                }
                            } else if (y && (l = (t[M] || (t[M] = {}))[e]) && l[0] === W) p = l[1];
                            else for (; (f = ++d && f && f[m] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v: 1 !== f.nodeType) || !++p || (y && ((f[M] || (f[M] = {}))[e] = [W, p]), f !== t)););
                            return p -= i,
                            p === r || p % r === 0 && p / r >= 0
                        }
                    }
        ...
        E = t.tokenize = function(e, n) {
            ...
            for (a = e, u = [], l = C.preFilter; a;) { (!r || (i = le.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push(o = [])),
                r = !1,
        ...
        S = t.select = function(e, t, n, r) {
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (i = he.needsContext.test(e) ? 0 : o.length; i--&&(s = o[i], !C.relative[a = s.type]);) if ((u = C.find[a]) && (r = u(s.matches[0].replace(we, Ce), xe.test(o[0].type) && c(t.parentNode) || t))) {
                    if (o.splice(i, 1), e = r.length && p(o), !e) return Q.apply(n, r),
                    n;
                    break
                }
            }
            return (l || N(e, f))(r, t, !H, n, xe.test(e) && c(t.parentNode) || t),
            n
        },
    ...
    Z.extend({
        ...
        ready: function(e) { (e === !0 ? --Z.readyWait: Z.isReady) || (Z.isReady = !0, e !== !0 && --Z.readyWait > 0 || (me.resolveWith(K, [Z]), Z.fn.triggerHandler && (Z(K).triggerHandler("ready"), Z(K).off("ready"))))
        }
    }),
    Z.ready.promise = function(t) {
        return me || (me = Z.Deferred(), "complete" === K.readyState ? setTimeout(Z.ready) : (K.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", s, !1))),
        me.promise(t)
    },
    Z.ready.promise();
    ...
    Z.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            }), t = (t || "").match(de) || [""], l = t.length; l--;) a = Ae.exec(t[l]) || [],
            d = m = a[1],
            h = (a[2] || "").split(".").sort(),
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (g && (u = g.events)) {
                for (t = (t || "").match(de) || [""], l = t.length; l--;) if (a = Ae.exec(t[l]) || [], d = m = a[1], h = (a[2] || "").split(".").sort(), d) {
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || K, 3 !== r.nodeType && 8 !== r.nodeType && !De.test(d + Z.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[Z.expando] ? t: new Z.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[d] || {},
    ...
    Z.extend({
        clone: function(e, t, n) {
            ...
            if (t) if (n) for (o = o || v(e), s = s || v(a), r = 0, i = o.length; i > r; r++) g(o[r], s[r]);
            else g(e, a);
            return s = v(a, "script"),
        ...
        buildFragment: function(e, t, n, r) {
            ...
            for (c.textContent = "", p = 0; i = f[p++];) if ((!r || -1 === Z.inArray(i, r)) && (u = Z.contains(i.ownerDocument, i), o = v(c.appendChild(i), "script"), u && m(o), n)) for (l = 0; i = o[l++];) Fe.test(i.type || "") && n.push(i);
            return c
        },
    ...
    Z.fn.extend({
        ...
        domManip: function(e, t) {
            ...
            p = e[0],
            m = Z.isFunction(p);
            if (m || l > 1 && "string" == typeof p && !G.checkClone && He.test(p)) return this.each(function(n) {
                var r = c.eq(n);
            ...
            if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                Fe.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Pe, "")))
            }
            return this
        }
    }),
    ...
    Z.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i: u[t] : (o = typeof n, "string" === o && (i = Ue.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n)), void 0)
            }
        },
    ...
    function(e, t) {
        Z.cssHooks[t] = {
            get: function(e, n, r) {
                return n ? ze.test(Z.css(e, "display")) && 0 === e.offsetWidth ? Z.swap(e, Je,
                function() {
                    return N(e, t, r)
                }) : N(e, t, r) : void 0
            },
    ...
    Z.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || wt) + "").replace(ft, "").replace(gt, Ct[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(de) || [""], null == f.crossDomain && (u = vt.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === Ct[1] && u[2] === Ct[2] && (u[3] || ("http:" === u[1] ? "80": "443")) === (Ct[3] || ("http:" === Ct[1] ? "80": "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), $(yt, f, t, w), 2 === x) return w;
            l = Z.event && f.global,
    ...
    Z.ajaxTransport(function(e) {
        ...
        return G.cors || Lt && !e.crossDomain ? {
            send: function(n, r) {
                ...
                t = function(e) {
                    return function() {
                        t && (delete At[s], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(jt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                            text: o.responseText
    ...
    Z.fn.extend({
        offset: function(e) {
            ...
            Z.contains(t, r) ? (typeof r.getBoundingClientRect !== Ee && (i = r.getBoundingClientRect()), n = W(o), {
